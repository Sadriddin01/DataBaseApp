...
namespace DateBaseSQL.Metods
{
    public partial class Select
    {
        ...
        // Get Table Values (var char , integer etc...)
        ...
        public static void CreateTable(string connectionString)
        {
            using (var connection = new NpgsqlConnection(connectionString))
            {
                ...
                while (addMoreColumns)
                {
                    ...
                    Console.Write("Enter the column data type ( VARCHAR(255), INTEGER, SERIAL, DECIMAL(10, 2), etc.): ");
            ...
            using (var connection = new NpgsqlConnection(connectionString))
            {
                ...
                switch (option)
                {
                    case "1": // Add a column
                        ...
                        Console.Write("Enter the data type ( VARCHAR(255), INTEGER): ");
        ...
        public static void GetAbout(string connectionString)
        {
            ...
            Console.Write("Enter Table Name to show what's in: ");
            string tableName = Console.ReadLine();
        ...
        //Insert Table
        public static void InsertToTable(string connectionString)
        {
        ...
        public static void DeleteTable(string connectionString)
        {
            using (var connection = new NpgsqlConnection(connectionString))
            {
                ...
                Console.Write("Enter the table name to delete: ");
                string tableName = Console.ReadLine();
